package com.wmachaca.airbnbclone.user.application;
...
public class Auth0Service {
    ...
    @Value("r22e4cpEdmlf8pD4fN4GH8EwvYxPk5sp")
    private String clientId;

    @Value("8l03v5ub3s6drcyMoB__ogJJDz83DaPKthCxR1fDrGF3gL6xsAW1IngYq7DzzONY")
    private String clientSecret;

    @Value("https://airbnb-clon.us.auth0.com/")
    private String domain;

    @Value("rol_DXRlpxifp9FLxZKz")
